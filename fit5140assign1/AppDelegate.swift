...
//        categoryController.managedObjectContext = self.managedObjectContext
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "ztia23.fit5140assign1" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("fit5140assign1", withExtension: "momd")!
